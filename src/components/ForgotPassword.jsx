          ...
          <div className="w-full max-w-md p-12">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <input className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-200 focus:border-orange-400 transition-all duration-200 bg-gray-50" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" required />
              </div>
              <button type="submit" className="w-full py-4 mt-6 bg-green-600 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02]">Send Reset Link</button>
            </form>
          </div>
        </div>
      </section>
